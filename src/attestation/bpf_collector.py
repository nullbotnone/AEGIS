...
try:
    ...
    from src.attestation.job_registry import JobRegistration, JobRegistry
    ...
    try:
        from .job_registry import JobRegistration, JobRegistry
    except ImportError:  # pragma: no cover - defensive fallback
        JobRegistration = None  # type: ignore[assignment]
        JobRegistry = None  # type: ignore[assignment]
    FrameworkActionType = None  # type: ignore[assignment]
    FrameworkAgentAction = None  # type: ignore[assignment]
    FrameworkEvidence = None  # type: ignore[assignment]
