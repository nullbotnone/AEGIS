...
are measured runtimes collected with time.perf_counter() while analyzing simulation-generated traces.
...
from src.paper.support.constraints import create_strict_constraints, ConstraintProfile
from src.paper.support.logger import ActionLogger, Action, ActionType
from src.paper.attacks.filesystem_injection import FilesystemInjectionAttack
from src.paper.attacks.colocation_injection import CoLocationInjectionAttack, ComputeNode
from src.paper.attacks.supply_chain_injection import SupplyChainInjectionAttack
from src.paper.attacks.coordinated_exfiltration import CoordinatedExfiltrationAttack
...
def run_experiment(output: Optional[str] = None):
    ...
    print("Detection times are measured runtimes over those traces (time.perf_counter()).")
